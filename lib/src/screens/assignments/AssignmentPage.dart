                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text("No limit", style: TextStyle(color: Colors.black.withOpacity(0.7)
                      ),
                      ),
                    ],
                  ),
            ...
            Expanded(child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  productListing('Assignment 1', 'Work the assigment properly..', 'inactive'),
                  productListing('Assingment 2', 'Work the assigment properly..', 'inactive'),
                  productListing('Assignment 3', 'Work the assigment properly..', 'inactive'),
                ],
              ),
            ))
          ],
        ...
        Row(
          children: <Widget>[
            Container(
              ...
              child: IconButton(
                icon: Icon(
                  Icons.assignment, color: (activeOrInactive == 'active') ? Colors.white : Color(0xff2657ce),
                ),
                onPressed: () {},
              ),
            ),
