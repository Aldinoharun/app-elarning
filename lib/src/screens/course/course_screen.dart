    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          SizedBox(height: 4,),
            Text(
                "Find a course you want to learn your",
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    courseWidget('Aritmetics', 'Matematika Course', 'img1', Color(0xFFB388FF), Colors.deepPurpleAccent),
                    SizedBox(height: 20,),
                    courseWidget('Language', 'Indonesia Language Course', 'img2', Color(0xffe9eefa), Colors.white),
                  ],
                ),
              ),
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(height: 50,),
                    courseWidget('Language', 'English Language Course', 'img3', Color(0xffe9eefa), Colors.white),
                    SizedBox(height: 20,),
                    courseWidget('Science', 'IPA Course', 'img4', Color(0xffbdcddfa), Color(0xffcedaff)),
                  ],
                ),
              )
            ],
