                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        width: 35,
                        child: IconButton(
                          icon: Icon(Icons.timer, color: Colors.blue,), onPressed: () {},
                        ),
                      ),
                      Text("2 Hours Per Material", style: TextStyle(color: Colors.black.withOpacity(0.7)
                      ),
                      ),
                    ],
                  ),
            ...
            Expanded(child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  productListing('Material 1', 'Learn about the material of..', 'inactive'),
                  productListing('Material 2', 'Learn about the material of..', 'inactive'),
                  productListing('Material 3', 'Learn about the material of..', 'inactive'),
                ],
              ),
            ))
          ],
        ...
        Row(
          children: <Widget>[
            Container(
              ...
              child: IconButton(
                icon: Icon(
                  Icons.assignment_turned_in, color: (activeOrInactive == 'active') ? Colors.white : Color(0xff2657ce),
                ),
                onPressed: () {},
              ),
            ),
